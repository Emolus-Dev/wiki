<template>
  <div class="wiki-toolbar" v-if="editor">
    <div class="toolbar-group">
      ...
      <AttachmentPrivacySelector
        :model-value="uploadIsPrivate"
        @update:model-value="emit('update:uploadIsPrivate', $event)"
      />
...
import AttachmentPrivacySelector from "./AttachmentPrivacySelector.vue";
...
const emit = defineEmits(["uploadImage", "update:uploadIsPrivate"]);
