      ...
      <div class="draggable-item">
        ...
        >
          <div class="flex items-center gap-2 flex-1 min-w-0">
            ...
            />
            <LucideLink
              v-else-if="element.is_external_link"
              class="size-4 text-ink-gray-5 flex-shrink-0"
            />
            <LucideFileText
              v-else
            ...
            <span
              class="text-sm truncate flex-1 min-w-0 transition-colors"
            ...
            <Badge
              v-if="changeTypeMap.get(element.doc_key) === 'added'"
              variant="subtle"
              theme="blue"
              size="sm"
              class="shrink-0"
            ...
            <Badge
              v-else-if="changeTypeMap.get(element.doc_key) === 'deleted'"
              variant="subtle"
              theme="red"
              size="sm"
              class="shrink-0"
            ...
            <Badge
              v-else-if="changeTypeMap.get(element.doc_key) === 'modified'"
              variant="subtle"
              theme="blue"
              size="sm"
              class="shrink-0"
            ...
            <Badge
              v-else-if="changeTypeMap.get(element.doc_key) === 'reordered'"
              variant="subtle"
              theme="orange"
              size="sm"
              class="shrink-0"
            ...
            <Badge
              v-else-if="!element.is_group && !element.is_published"
              variant="subtle"
              theme="orange"
              size="sm"
              class="shrink-0"
...
function isRowActionVisible(element) {
